...
def configure_simulation():
     ...
     while stabilization_choice not in [1, 2, 3, 4]:
...
def setup_simulation(t_end, stabilization_choice):
    ...
    stabilization_graph_titles = ['1D Shock Tube (RK4-Standard Galerkin) ', '1D Shock Tube (TG2-One step)', '1D Shock Tube (TG2-Two step)', '1D Shock Tube (RK4-TG2 Two step)']
    folder_paths = ['./sod_tube_RK4_standard_galerkin', './sod_tube_TG2_one_step', './sod_tube_TG2_two_step', './sod_tube_RK4_TG2_two_step']
    file_names = ['sod_tube_RK4_standard_galerkin', 'sod_tube_TG2_one_step', './sod_tube_TG2_two_step', './sod_tube_RK4_TG2_two_step']
    methods_file_name = ['RK4_standard_galerkin', 'TG2_one_step', 'TG2_two_step', 'RK4_TG2_two_step']
